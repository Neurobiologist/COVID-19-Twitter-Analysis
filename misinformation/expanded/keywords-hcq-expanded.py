...
# Define directories
root_dir = '/projectnb/caad/meganmp/data/misinformation/expanded' 
save_dir = '/projectnb/caad/meganmp/analysis/results/misinformation/expanded'
...
def main():
    ...
    with open(os.path.join(root_dir, 'hcq-expanded-tweets.jsonl.gz'), 'rb') as f:
    ...
    # Save pkl file
    tweet_df.to_pickle('hcq_expanded_df.pkl')
    # Load pkl file
    # tweet_df = pd.read_pickle('hcq_expanded_df.pkl')
    ...
    with open('network_analysis-expanded.txt', 'w') as file_out:
        ...
        file_out.write('Most connected user = {}\n'.format(most_connected_user))
