'''
Isolate and Characterize Hydroxychloroquine Tweets
...
save_dir = '/projectnb/caad/meganmp/data/misinformation/' 
...
def main():
    ...
    # Traverse the data
    with gzip.open(os.path.join(save_dir, 'hcq-tweets.jsonl.gz'), 'w') as file_out:
                            ...
                            try:
                                for line in gzip_file:
                                    ...
                                    if line:
                                        ...
                                        # Identify Keywords
                                        try:
                                            if 'hydroxychloroquine' in tweet_content['entities']['hashtags'][0]['text']:
